...
# Build tag expression - can be used to evaluete a shell expression at runtime
...
# Set DOCKER_REGISTRY_AUTH to auth endpint for private Docker registry
